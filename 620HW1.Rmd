...
ggsave("HD1_2q_social.png", social)
...
total_occupation_curve <- ggplot(ST00_ps, aes(x = Date, y = Total.ST.min.true)) +
  geom_line(color = "blue") +
  geom_point(color = "black") +
  xlab("") + ylab("Total Screen Time (minutes)") +
  theme_minimal()

# Occupation time curve for Social.ST.min.true
social_occupation_curve <- ggplot(ST00_ps, aes(x = Date, y = Social.ST.min.true)) +
  geom_line(color = "blue") +
  geom_point(color = "black") +
  xlab("") + ylab("Social Screen Time (minutes)") +
  theme_minimal()

# Occupation time curve for Pickups
pickups_occupation_curve <- ggplot(ST00_ps, aes(x = Date, y = Pickup.1st)) +
  geom_line(color = "blue") +
  geom_point(color = "black") +
...
social_ratio_occupation_curve <- ggplot(ST00_ps, aes(x = Date, y = social.ratio)) +
  geom_line(color = "blue") +
  geom_point(color = "black") +
  xlab("") + ylab("Social Ratio") +
  theme_minimal()

# Occupation time curve for daily_duration_per_use
daily_duration_occupation_curve <- ggplot(ST00_ps, aes(x = Date, y = daily_duration_per_use)) +
  geom_line(color = "blue") +
  geom_point(color = "black") +
  xlab("") + ylab("Daily Duration per Use") +
  theme_minimal()
...
# Show the plots
ggsave("HD1_2c_total_occupation_curve.png", total_occupation_curve)
ggsave("HD1_2c_social_occupation_curve.png", social_occupation_curve)
ggsave("HD1_2c_pickups_occupation_curve.png", pickups_occupation_curve)
ggsave("HD1_2c_social_ratio_occupation_curve.png", social_ratio_occupation_curve)
ggsave("HD1_2c_daily_duration_occupation_curve.png", daily_duration_occupation_curve)
...
pickups_acf <- acf(ST00_ps$Pickup.1st, plot = FALSE)
